...
const MobileFilterDrawer = ({
  ...
  const [activeSection, setActiveSection] = useState<'main' | 'category' | 'price' | 'sort'>('main');

  const hasActiveFilters = selectedCategory || priceRange[0] > 0 || priceRange[1] < 20000 || sortBy !== 'featured';
  const filterCount = [
